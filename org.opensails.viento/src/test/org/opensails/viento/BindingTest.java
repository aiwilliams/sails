...
public class BindingTest extends TestCase {
	...
	public void testUnresolvableObjectPassedAsNull() throws Exception {
		assertTrue((Boolean) binding.call(target, "isNull",
				new Object[] { binding.call("notThere") }));
	}
	...
	public void testVarargs() throws Exception {
		...
		assertEquals(2, binding.call(target, "varargs", new Object[] { "one",
				"two" }));
	}
	...
	public void testCall_Arguments() throws Exception {
		assertEquals("two", binding.call(target, "two",
				new Object[] { new HashSet() }));
		assertEquals("three", binding.call(target, "three",
	...
	public void testTypeMixin() throws Exception {
		...
		assertEquals("str", binding.call("string", "sansSuffix",
				new Object[] { "ing" }));
	...
	public void testMethodMissing() throws Exception {
		assertEquals("methodMissing", ((Object[]) binding.call(
				new ShamMethodMissing(), "method"))[0]);
		assertEquals("methodMissing", ((Object[]) binding.call(
				new ShamMethodMissingNoInterface(), "method"))[0]);
		assertEquals("methodMissing", ((Object[]) binding.call(
				new ShamMethodMissingOnSuper(), "method"))[0]);
	}

	/**
	 * There was a bug where the method being invoked was included in the
	 * argument array passed to method missing - it is the first argument to
	 * methodMissing.
	 */
	public void testMethodMissing_TopLevelMixin() throws Exception {
		...
		assertTrue("Expected no arguments but was " + result[1], Arrays.equals(
				new Object[0], (Object[]) result[1]));
	}

	public void testPolymorphism() throws Exception {
		assertEquals("object", binding.call(target, "polymorphism",
				new Object[] { new Object() }));
		assertEquals("string", binding.call(target, "polymorphism",
	...
	public void testPublicFields() throws Exception {
		...
		assertEquals(target, binding.call(target, "field",
				new Object[] { "different" }));
	...
	class ShamMethodMissingOnSuper extends ShamMethodMissing {
	}
