...
import org.opensails.sails.template.viento.BlockInlineContent;
...
public class ScriptMixin implements IMixinMethod<Script> {
	...
	public Script invoke(Object... args) {
		...
		if (args[0].getClass().equals(Block.class)) return new Script(new BlockInlineContent((Block) args[0]));
