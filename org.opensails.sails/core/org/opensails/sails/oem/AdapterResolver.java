...
import org.opensails.sails.adapter.oem.DefaultAdapterResolver;
...
public class AdapterResolver implements IAdapterResolver {
	...
	public AdapterResolver() {
		...
		push(new DefaultAdapterResolver());
	}
	...
	public IAdapter resolve(Class<?> parameterClass, ScopedContainer container) {
		...
		if (scope != null) {
			ScopedContainer targetContainer = container.getContainerInHierarchy(scope);
