...
public class BasicComponentTests extends TestCase {
	...
	public void testScriptInit() throws Exception {
		...
		Page page = c.render();
		assertEquals("window.someid=new ScriptInit({property:'asdf',classProperty:'org.opensails.component.tester.SailsComponentTester',array:['asdf'],id:'someid',callback:Component.callback('callback','http://localhost/shamcontext/shamservlet/component_scriptInit/callback',{method:'get',parameters:'classProperty=org.opensails.component.tester.SailsComponentTester&id=someid'}),something:$('someid_something')});", page.source());
