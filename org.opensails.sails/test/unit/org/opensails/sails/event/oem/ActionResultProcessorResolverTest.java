...
public class ActionResultProcessorResolverTest extends TestCase {
	...
	public void testIt() throws Exception {
		...
		resolver.push(new ClassResolverAdapter<ShamResultProcessor>() {
			@Override
			public Class<ShamResultProcessor> resolve(Class key) {
				classResolveCount++;
	...
	public void testPush() throws Exception {
		...
		ClassResolverAdapter<IActionResultProcessor> resolverOne = new ClassResolverAdapter<IActionResultProcessor>() {
			@Override
			public Class<IActionResultProcessor> resolve(Class key) {
				throw new AssertionFailedError("This should not be used, as two is pushed on last");
			}
		};
		ClassResolverAdapter<ShamActionResultProcessor> resolverTwo = new ClassResolverAdapter<ShamActionResultProcessor>() {
			@Override
			public Class<ShamActionResultProcessor> resolve(Class key) {
